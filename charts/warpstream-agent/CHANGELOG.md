...
## [1.0.86] - 2026-09-03
- Use the agent service account for the dedicated metrics pod by default and add `dedicatedMetricsPod.serviceAccountName` to select a separately managed account.
